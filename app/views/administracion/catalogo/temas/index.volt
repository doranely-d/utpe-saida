        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"> Administración de Temas</h3>
                </div>
                <div class="box-body">
                    <div class="rows">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group pull-left" style="margin-top: 10px; margin-bottom: 10px;">
                                    <button id="btnAgregarTema" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Agregar Acción">
                                        <span class="glyphicon glyphicon-plus"></span>&nbsp;Agregar Tema
                                    </button>
                                </div>
                                <table id="tblTemas"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-sortable="false" data-align="center" data-width="100" data-formatter="temas.actionFormatter">ACCIONES</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
...
{% block footer %}
    ...
    {{ javascript_include('js/views/administracion/catalogo/temas.js') }}
{% endblock %}