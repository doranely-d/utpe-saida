...
class SdParametros extends \Phalcon\Mvc\Model
{
    /**
     *
     * @var integer
     * @Primary
     * @Column(column="ID_PARAMETRO", type="integer", length=7, nullable=false)
     */
    public $id_parametro;
     ...
     *
     * @var string
     * @Column(column="VALOR", type="string", length=20, nullable=false)
     */
    public $valor;
     ...
     * @return SdParametros[]|SdParametros|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return SdParametros|\Phalcon\Mvc\Model\ResultInterface
     */
