        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"> Administración de items del menú</h3>
                </div>
                <div class="box-body">
                    <div class="rows">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group well well-sm">
                                    <button id="btnAgregarMenu" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Agregar Menú">
                                        <span class="glyphicon glyphicon-plus"></span>&nbsp;Agregar Menú
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <table id="tblMenu"
                                    ...
                                    <thead>
                                        <tr>
                                            <th data-field="ID_MENU" data-sortable="true">ID</th>
                                            ...
                                            <th data-field="PADRE" data-sortable="true">MENU PADRE</th>
                                            <th data-sortable="false" data-align="center" data-width="100" data-formatter="menu.actionFormatter">ACCIONES</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
...
{% block footer %}
    ...
    {{ javascript_include('js/views/administracion/menus.js') }}
{% endblock %}