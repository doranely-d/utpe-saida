        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"> Administración de Títulos</h3>
                </div>
                <div class="box-body">
                    <div class="rows">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group pull-left" style="margin-top: 10px; margin-bottom: 10px;">
                                    <button id="btnAgregarTitulo" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Agregar Título">
                                        <span class="glyphicon glyphicon-plus"></span>&nbsp;Agregar Título
                                    </button>
                                </div>
                                <table id="tblTitulo"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-sortable="false" data-align="center" data-width="100" data-formatter="titulos.actionFormatter">ACCIONES</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
...
{% block footer %}
    ...
    {{ javascript_include('js/views/administracion/catalogo/titulos.js') }}
{% endblock %}