                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group pull-left" style="margin-top: 10px; margin-bottom: 10px;">
                                    <button id="btnAgregarRol" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Agregar Rol">
                                ...
                                <table id="tblRoles"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-sortable="false" data-align="center" data-width="100" data-formatter="roles.actionFormatter">ACCIONES</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
...
{% block footer %}
    ...
    {{ javascript_include('js/views/administracion/permisos/roles.js') }}
{% endblock %}