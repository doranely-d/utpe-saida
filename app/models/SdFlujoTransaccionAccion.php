...
class SdFlujoTransaccionAccion extends \Phalcon\Mvc\Model
{
    /**
     *
     * @var integer
    ...
    public function initialize()
    {
        ...
        $this->setSource("sd_flujo_transaccion_accion");
        $this->belongsTo('ID_ACCION', '\SdFlujoAccion', 'ID_ACCION', ['alias' => 'SdFlujoAccion']);
        $this->belongsTo('ID_TRANSACCION', '\SdFlujoTransaccion', 'ID_TRANSACCION', ['alias' => 'SdFlujoTransaccion']);
    }
    ...
    {
        return 'sd_flujo_transaccion_accion';
    }
     ...
     * @return SdFlujoTransaccionAccion[]|SdFlujoTransaccionAccion|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return SdFlujoTransaccionAccion|\Phalcon\Mvc\Model\ResultInterface
     */
