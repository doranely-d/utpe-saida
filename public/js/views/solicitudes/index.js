...
var solicitudes = {
    ...
    init: function () {
        ...
        this.tblSolicitudes.bootstrapTable({
            url: general.base_url + '/solicitudes/listar?opt=0&tipo='+solicitudes.txtTipoSolicitud.val(),
        });
    ...
    cargaPreguntas: function (idSolicitud) {
        ...
        solicitudes.tblPreguntas.bootstrapTable({
            url: general.base_url + '/solicitudes/listar?opt=1&id_solicitud=' + idSolicitud,
        });
